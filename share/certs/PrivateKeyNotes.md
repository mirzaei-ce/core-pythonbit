...
unlocked to sign the Pythonbit-Qt.app bundle.
...
allowing somebody to distribute a Pythonbit-Qt.app or pythonbit-qt-setup.exe with a valid
...
that the pythonbit-qt.exe file inside the installer had not been tampered with.
