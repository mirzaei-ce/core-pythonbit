...
This document provides guidelines for internationalization of the Pythonbit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `pythonbit_en.ts` remains unchanged.
