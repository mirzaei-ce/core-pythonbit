Download URL: https://sourceforge.net/projects/pythonbit/files/Pythonbit/pythonbit-0.3.22/
...
* IRC is overflowing.  Client now bootstraps to channels #pythonbit00 - #pythonbit99
