Pythonbit Core version 0.9.4 is now available from:

  https://pythonbit.org/bin/0.9.4/
...
this update is incompatible with the Pythonbit system and could lead to consensus
forks.

Pythonbit Core released binaries from https://pythonbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~pythonbit/+archive/ubuntu/pythonbit
- A third-party or self-compiled Pythonbit Core

upgrade to Pythonbit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
