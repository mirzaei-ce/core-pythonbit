Pythonbit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/pythonbit/files/Pythonbit/pythonbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Pythonbit
...
New/changed settings (command-line or pythonbit.conf file)
--------------------------------------------------------
