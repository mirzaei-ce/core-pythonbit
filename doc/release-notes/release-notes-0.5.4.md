Pythonbit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/pythonbit/files/Pythonbit/pythonbit-0.5.4/
...
http://gitorious.org/pythonbit/pythonbitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Pythonbit-Qt notifications under Growl 1.3.
Increase required age of Pythonbit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPythonbit properly when installing Pythonbit-Qt over it. (Windows)
