Pythonbit Core version 0.10.3 is now available from:

  <https://pythonbit.org/bin/pythonbit-core-0.10.3/>
...
(see https://github.com/pythonbit/pythonbit/pull/6793, as well as the 0.11.0
