# mininode.py - Pythonbit P2P network half-a-node
#
...
#
# NodeConn: an object which manages p2p connectivity to a pythonbit node
# NodeConnCB: a base class that describes the interface for receiving
#             callbacks with network messages from a NodeConn
# CBlock, CTransaction, CBlockHeader, CTxIn, CTxOut, etc....:
#     data structures that should map to corresponding structures in
#     pythonbit/primitives
...
# Objects that map to pythonbitd objects, which can be serialized/deserialized
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in pythonbitd indicates these should be deserialized as blocks
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest", services=1):
        ...
        print 'MiniNode: Connecting to Pythonbit Node IP # ' + dstaddr + ':' \
            + str(dstport)
