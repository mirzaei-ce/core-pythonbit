...
'''
This reimplements tests from the pythonbitj/FullBlockTestGenerator used
by the pull-tester.
...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Extend the b26 chain to make sure pythonbitd isn't accepting b26
        ...
        # Extend the b28 chain to make sure pythonbitd isn't accepted b28
