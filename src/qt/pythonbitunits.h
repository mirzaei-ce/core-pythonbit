...
#ifndef PYTHONBIT_QT_PYTHONBITUNITS_H
#define PYTHONBIT_QT_PYTHONBITUNITS_H
...
/** Pythonbit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PythonbitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PythonbitUnits(QObject *parent);

    /** Pythonbit units.
      @note Source: https://en.pythonbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        PBT,
...
typedef PythonbitUnits::Unit PythonbitUnit;

#endif // PYTHONBIT_QT_PYTHONBITUNITS_H
