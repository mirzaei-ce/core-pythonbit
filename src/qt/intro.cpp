...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/pythonbit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Pythonbit Core"),
     ...
     * override -datadir in the pythonbit.conf file in the default data directory
     * (to be consistent with pythonbitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
