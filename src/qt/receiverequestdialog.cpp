...
#include "config/pythonbit-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatPythonbitURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + PythonbitUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatPythonbitURI(info));
}
