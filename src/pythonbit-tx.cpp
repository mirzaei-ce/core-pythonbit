...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Pythonbit Core pythonbit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pythonbit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pythonbit transaction") + "\n" +
              "  pythonbit-tx [options] -create [commands]   " + _("Create hex-encoded pythonbit transaction") + "\n" +
              "\n";
...
static void MutateTxAddOutAddr(CMutableTransaction& tx, const string& strInput)
{
    ...
    CPythonbitAddress addr(strAddr);
    if (!addr.IsValid())
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pythonbit transaction
