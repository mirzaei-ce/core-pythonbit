...
#ifndef PYTHONBIT_TEST_SCRIPTNUM10_H
#define PYTHONBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Pythonbit Core 0.10.0, for cross-comparison.
 */
public:
