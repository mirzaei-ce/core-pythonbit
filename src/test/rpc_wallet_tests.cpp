...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CPythonbitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CPythonbitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CPythonbitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CPythonbitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CPythonbitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CPythonbitAddress(arr[0].get_str()).Get() == demoAddress.Get());
